...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Obrońca zamienia się pozycją z innym zawodnikiem kiedy idzie do strefy kar (patrz 9.4.2.) %TODO ref
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Strefy kar (2.1.5.) %TODO ref
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \begin{enumerate}
        ...
        \item Zawodnicy na zewnątrz boiska, wprowadzający piłkę do wewnątrz. (patrz 7.5.4.) %TODO ref
      \end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Wyraźnym ogłoszeniu upłynięcia 17 minut czasu gry (patrz 3.3.4.) %TODO ref
    ...
    \item Ogłaszanie pozostałego czasu w dogrywce oraz przestrzeganie dodatkowych zasad dogrywki (patrz 3.5.3.) %TODO ref
  \end{enumerate}
