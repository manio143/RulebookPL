...
\begin{enumerate}
  ...
  \item Płeć z jaką gracz się identyfikuje uznawana jest za płeć tego gracza.
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      \item W tym przypadku gracz wchodzi na boisko z ławki rezerwowych.
    \end{enumerate}
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
  \end{enumerate}
  \item Wchodzący na boisko gracz dostaję karę jeśli niewłaściwie przeprowadzono zmianę.
  \item Jeśli gracz wejdzie na boisko po niewłaściwym przeprowadzeniu zmiany, ale jeszcze nie wejdzie w interakcję z grą, \emph{official} powinien nakazać mu powtórzenie procedury.
  \begin{enumerate}
    \item Jeśli gracz wejdzie w interakcję z grą przed decyzją \emph{official} lub przed poprawieniem procedury, musi być ukarany za nielegalną zmianę.
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Obrońca zamienia się pozycją z innym graczem kiedy idzie do \emph{penalty box} (patrz 9.4.2.) %TODO ref
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Jeśli kontuzja nie jest poważna, a gracz nie przeszkadza w dalszym rozegraniu akcji, sędzia główny powinien pozwolić grze na kontynuację, dopóki jej zatrzymanie nie będzie powodowało przewagi dla którejś z drużyn lub gra zbliży się do kontuzjowanego gracza.
  \end{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item Jeśli nie ma żadnych nadających się rezerwowych, spełniających zasadę gender, drużyna może grać z jednym graczem mniej.
      \begin{enumerate}
