...
\renewcommand*\familydefault{\sfdefault} %% option 'sfdefault' activates Clear Sans as the default text font
...
\usepackage{enumitem}
\setenumerate[1]{leftmargin=4cm,label=\Alph*.}
...
\titlespacing*{\subsubsection}{1.5cm}{0pt}{0pt}
\titlespacing*{\paragraph}{2.8cm}{0pt}{0pt}
