...
\newcommand\redcard[1]{\textcolor{darkgreen}{\textbf{Kara: }}\textcolor{red}{\textbf{Czerwona Kartka}} -- #1}
\newcommand\yellowcard[1]{\textcolor{darkgreen}{\textbf{Kara: }}\textcolor{darkyellow}{\textbf{Żółta Kartka}} -- #1}
\newcommand\bluecard[1]{\textcolor{darkgreen}{\textbf{Kara: }}\textcolor{blue}{\textbf{Niebieska Kartka}} -- #1}
\newcommand\penaltyd[2]{\textcolor{darkgreen}{\textbf{Kara: #1}} -- #2}
...
\begin{enumerate}
  ...
  \item Podczas uziemienia szukających, drużyna nie może mieć w grze szukającego. Po za nim, drużyna musi mieć szukającego w grze.
  \begin{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item Po zakończeniu uziemienia szukających, jeden szukający również jest obowiązkowy.
    \end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Jeśli zawodnik wejdzie w interakcję z grą przed decyzją sędziego lub przed poprawieniem procedury, musi być ukarany za nielegalną zmianę.
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Zmiana zawodnika wyrzuconego z boiska (patrz \myref{9.1.6}).
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Linie pola obrońcy (\myref{2.1.3}).
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Zawodnicy ukarani kartką przechodzą do strefy kar.
  ...
  \end{enumerate}
  \item Piłki, które wyleciały za granice boiska są umieszczane dwa metry wewnątrz boiska od miejsca gdzie piłka opuściła boisko.
  \begin{enumerate}
    \item Piłka jest wewnątrz boiska i nie musi być wprowadzona do wewnątrz przez którąkolwiek z drużyn.
...
Uziemienie szukających to pierwsze 18 minut czasu gry pierwszego etapu gry i 30 sekund drugiego etapu gry (dogrywki), podczas których znicz nie może zostać złapany.
\begin{enumerate}
  \item Uziemienie szukających jest mierzone w czasie gry, a nie w czasie rzeczywistym.
  \item Podczas uziemienia szukających, szukający nie biorą udziału w grze.
  \item Szukający z każdej drużyny musi stawić się do \emph{timekeepera} do 17 minuty czasu gry.
  \begin{enumerate}
    \item Szukający są zawodnikami rezerwowymi podczas uziemienia szukających i nie mogą wejść na boisko zanim nie zostaną wypuszczeni przez \emph{timekeepera}.
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Po upewnieniu się ze wszystkimi sędziami, że nie ma więcej spraw, kar itd. oraz że etap się zakończył, sędzia główny gwiżdże trzykrotnie długie gwizdki aby oznajmić koniec etapu gry.
    \begin{enumerate}
...
\begin{enumerate}
  ...
  \item Jeśli poprzedni etap zakończył się złapaniem znicza, to złapanie liczy się jako pojedyńczy gol na rzecz wypuszczenia zawodnika ze strefy kar.
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Przed zawołaiem ,,Miotły w górę!'' szukający muszą stawić się do \emph{timekeepera}, aby być wypuszczonym po zakończeniu 30 sekundowego uziemienia szukających.
    ...
    \begin{enumerate}
      \item Szukający pozostaje w strefie kar i nie może wejść do gry w trakcie uziemienia szukających.
  ...
  \begin{enumerate}
    ...
    \item Jeśli sędzia podniesie rękę sygnalizując przywilej korzyści lub opóźnioną karę, \emph{timekeeper} zatrzymuje zegar dopóki gra nie zostanie wstrzymana, a faul ukarany.
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
  \item Jeśli którykolwiek z oryginalnych sędziów jest niedostępny to dyrektor turnieju wyznacza jego zastępcę.
  ...
  \begin{enumerate}
    \item Wszelkie ograniczenia nałożone na znicz przed odłożeniem gry, nadal muszą być stosowane.
  \end{enumerate}
  \item Sędzia główny woła ,,Miotły w dół!''
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Kafel nie był \emph{unscorable} (patrz \myref{5.6.3}).
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Żaden sędzia ani zawodnik drużyny łapiącej nie wpadł na znicz w taki sposób, że ułatwiłoby to złapanie.
    \begin{enumerate}
...
\begin{enumerate}
  \item Jeśli zawodnik zejdzie z miotły w wyniku nielegalnej akcji przeciwnika, sędzia może pozwolić zawodnikowi spowrotem wejść na miotłę i kontynuować grę. Jeśli zawodnik od razu nie wejdzie na miotłę, musi przejść procedurę zbicia.
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Nie mógł dotknąć ziemi, wyjść na zewnątrz boiska lub być złapanym.
    \begin{enumerate}
...
\begin{enumerate}
  ...
  \item Próba skradzenia kafla, kontaktowanie lub inna interakcja z chronionym obrońcą, który jest w samodzielnym posiadaniu kafla (patrz \myref{7.2}).
\end{enumerate}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item Kontakt rozpoczęty w ten sposób nie pozwala na kontynuowanie kontntaktu w sposób wymieniony w \myref{6.1.9}.
\end{enumerate}
...
\redcard{Wyjątkowo nadmierny kontakt przeciwko przeciwnikowi, sędziemu, widzowi lub organizatorowi turnieju}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
    \item Wyjątkowo nadmierny kontakt ze zniczem (patrz \myref{6.1.13}).
  \end{enumerate}
...
\begin{enumerate}
  ...
  \item Kafel wprowadzony przez rzut jest \emph{unscorable} (patrz \myref{5.6.3}).
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Ubranie znicza musi zostać poprawione, zgodnie z opisem w \myref{8.4.2}.
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      \item Wszystkie wymagania i procedury związane z wyrzuconymi zawodnikami muszą być przestrzegane (patrz \myref{9.1.6}).
    \end{enumerate}
  \end{enumerate}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item Jeśli znicz i inny sędzia mają odmienne zdanie, to znicz musi ustąpić decyzji sędziego jesli gra nie jest wstrzymana.
\end{enumerate}
...
Sędzia główny może zmienić decyzji o tym czy był gol w dowolnym momencie zanim poprzednio broniąca się drużyna będzie posiadać kafel poza swoim polem obrońcy i zawodnik z kaflem dokona znaczącej interakcji lub zagrania.
...
\yellowcard{Nieposłuchanie się polecenia sędziego}

\subsubsection{Używanie poleceń sędziów}
Zawodnicy i personel drużyny nie mogą używać poleceń lub sygnałów sędziów, zarówno słownych jak i gestów.
