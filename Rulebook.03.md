...
* Drużyna musi wybrać jedną osobę, która jako _speaking captain_, będzie ich reprezentowała podczas gry.
...
* Kiedy obaj ścigający z punktu C się ustawili, pozostali ścigający i pałkarz ustawiają się dowolnie na linii bocznej swojej połowy, poza strefą rozpoczynających.
...
* Jeśli zawodnik otrzyma kartkę przed rozpoczęciem gry, przechodzi do strefy kar przed rozpoczęciem gry.
...
* Sędzia główny woła ,,Miotły w dół!''. Rozpoczynający zawodnicy biorą miotłę w rękę i kładą ją na ziemi. Do zawołania ,,Miotły w górę!'' zachodzą następujące:
    * Zawodnicy nie mogą dotykać ziemi za ich linią startową żadną częścią ciała lub wyposażenia, poza miotłą.
...
* Kilka sekund po zawołaniu ,,Gotowi!'', sędzia główny woła ,,Miotły w górę!''
    ...
    * Jeśli pojawi się fałszywe zawołanie ,,Miotły w górę!'', sędzia główny:
        ...
        * Resetuje zawodników do pozycji z momentu zawołania ,,Miotły w dół!''.
...
* Zawodnicy będący aktualnie w grze muszą się zatrzymać, puścić swoje miotły i pozostać na pozycjach w których się zatrzymali.
...
* Jeśli następuje przekazanie piłek, procedura przekazania powinna zostać wykonana przed ponownym rozpoczęciem gry.
* Jakiekolwiek wolne oraz żywe piłki, które były w powietrzu i niczego nie dotknęły przed gwizdkami (zawodnika, sprzętu, lub ziemi) są zwrócone do osób, które wprawiły je w ruch.
...
* Wolnym piłkom, które były w ruchu i czegoś dotknęły (w tym zawodników, sprzęt lub ziemię) zanim sędzia zagwizdał, pozwala się na to aby dokończyły swój ruch aż do zatrzymania lub wyjścia poza boisko.
    * Jeśli piłka wyleciała za granice boiska po gwizdkach, są umieszczane przez sędziego dwa metry wewnątrz boiska od miejsca gdzie piłka opuściła boisko i nie trzeba jej wprowadzać.
    * Jeśli piłka się poruszy po tym jak się zatrzymała to należy ją cofnąć do miejsca pierwotnego zatrzymania.
...
* Sędzia główny powiadamia zawodników, że gra zaraz będzie wznowiona zawołaniem ,,Na miotły!''
    ...
    * Zawodnicy mogą zmienić lekko pozycję aby przygotować się do startu, ale nie mogą popełnić falstartu.
        * Falstart zachodzi gdy zawodnik zrobi jedną z poniższych rzeczy przed gwizdkiem oznaczającym wznowienie gry:
        ...
        * Pierwszy falstart w czasie zatrzymania gry skutkuje ostrzeżeniem dla wszystkich zawodników na boisku.
            * Każdy kolejny falstart w czasie tego samego zatrzymania gry przez jakiegokolwiek gracza skutkuje karą.
...
* Są dwa sposoby aby poprosić o _timeout_.
    * _Speaking captain_ może poprosić o _timeout_ podczas dowolnego wstrzymania gry.
    * _Speaking captain_ może poprosić o _timeout_ podczas przestoju w grze podczas pierwszy 17 minut czasu gry. Przestój następuje kiedy na boisku nie odbywa się żadne aktywne zagranie.
        * _Timekeeper_ musi jasno ogłosić moment 17 minuty czasu gry.
        * Sędzia powinien szybko sprawdzić boisko, czy nie ma żadnych aktywnych zagrań, włączając w to zagrania z pałkarzami i tłuczkami, przed zezwoleniem na wstrzymanie gry.
    ...
    * Kara za nielegalny _timeout_ może zostać nałożona tylko jeśli prośba o _timeout_ była celowo nielegalna albo jeśli sędzia zatrzyma grę lub spełni prośbę zanim zorientuje się, że _timeout_ był nielegalny.
...
Uziemienie szukających to pierwsze 18 minut czasu gry, podczas których znicz nie może zostać złapany.
...
* Szukający z każdej drużyny musi stawić się u _timekeepera_ do 17 minuty czasu gry.
    * Szukający w czasie uziemienia są uznawani za zawodników rezerwowych i nie mogą wejść na boisko zanim nie zostaną wypuszczeni przez _timekeepera_.
    * Nie ma kary za niestawienie się do _timekeepera_ w wyznaczonym czasie. Aczkolwiek rozpoczynający szukający drużyny nie może wejść na boisko, jeśli nie zostanie wypuszczony przez _timekeepera_ ze strefy kar.
...
### Złapanie znicza
Po tym jak złapanie znicza zostało potwierdzone i łapiąca drużyna otrzymała 30 punktów:

* Jeśli łapiąca drużyna ma więcej punktów niż przeciwna, łapiąca drużyna wygrywa, a sędzia główny gwiżdże trzy długie gwizdy, aby oznajmić koniec gry.
* Jeśli łapiąca drużyna nie ma więcej punktów niż przeciwna, gra przechodzi do dogrywki.
...
* Gra zostaje wznowiona zgodnie ze standardową procedurą (patrz \myref{3.3.3}).
...
* Jeśli poddająca drużyna przegrywa, sędzia główny ogłasza koniec gry trzema długimi gwizdami. Wynik w momencie poddania staje się oficjalnym wynikiem, a prowadząca drużyna wygrywa.
* Jeśli poddająca drużyna nie przegrywa, przeciwna drużyna otrzymuje tyle punktów, aby mieć 10 punktową przewagę. Sędzia główny ogłasza koniec gry trzema długimi gwizdami. Otrzymany wynik staje się oficjalnym wynikiem, a niepoddająca się drużyna wygrywa.
* Tylko _speaking captain_ może poddać grę w imieniu drużyny. Jego decyzja jest ostateczna.
* Gra może zostać poddana w dowolnym momencie rozgrywki, również kiedy gra nie jest wstrzymana lub zanim zostanie rozpoczęta po złapaniu.
...
* Sędzia główny musi ogłosić poddanie gry jeśli:
    ...
    * Drużyna odmawia wznowienia odłożonej gry bez zgody przeciwnika oraz organizatorów turnieju.
...
* Odłożona gra musi zostać zarejestrowana z bieżącym czasem gry, wynikiem,
  zawodnikami na boisku, zawodnikami w strefie kar i pozostałym czasem kar, oraz posiadaniem piłek.
    * Wolne piłki, poza zniczem, powinny zostać przypisane drużynom na podstawie uznania sędziego głównego, która drużyna zdobyłaby posiadanie danej piłki.
        ...
        * Jeśli obaj pałkarze drużyny odsiadują karę, to i tak powinien im być przypisany przynajmniej jeden tłuczek.
* Odłożone gry powinny zostać wznowione przy najbliższej możliwej i w pełni bezpiecznej okazji.
...
* Wszyscy zawodnicy, którzy byli w grze w momencie jej zawieszenia rozpoczynają grę w swoich polach obrońcy.
    * Zawodnicy wchodzą w posiadanie piłek, które posiadali lub które zostały im przypisane gdy gra została odłożona.
    * Jeśli drużyna ma obu pałkarzy w strefie kar, tłuczek umieszczany jest przy środkowej pętli.
* Jeśli gra została odłożona po 17 minucie gry, a znicz nie był jeszcze złapany, to znicz musi znajdować się na boisku przed wznowieniem gry.
